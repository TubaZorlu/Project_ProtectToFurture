...
{
	public class DonorCreatedValidator: AbstractValidator<DonorCreateDto>
	{
		public DonorCreatedValidator()
		{
			...
			RuleFor(x => x.DonorCity).NotEmpty().WithMessage("Şehir boş geçilemez");
		}
	}
}
